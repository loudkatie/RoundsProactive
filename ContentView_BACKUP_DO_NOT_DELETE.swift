...
final class AppState: ObservableObject {
    ...
    // Move to the next logical step in the flow
    func proceed() {
...
// MARK: - Splash Screen
// Shows a breathing heart on blue gradient, auto-advances after ~1.6s
...
// Sets tone: “I’ll help you keep track. You’re not alone in this.”
...
// Big mic button. User taps, it “records”. Tap Done to continue.
// This is simulation mode right now — no real audio yet.
...
// MARK: - Summary Screen
// Fake “AI reflection.” In real build we’ll feed transcript → GPT → summary.
// For now it pretends to “analyze”, shows a summary, then lets you Save/Discard.
struct SummaryView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            // pretend we're doing AI summary work
